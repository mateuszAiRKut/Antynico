...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class DatabasePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("example_text_Db"));
            EditTextPreference editText = (EditTextPreference) findPreference("example_text_Db");
            //ManagerDatabase mdb =  LoginActivity.getObjectDataBase();
            //mdb.RemoveUser(1);
            //mdb.RemoveUser(2);
            //mdb.RemoveUser(3);

            //Cursor k = mdb.ViewAllUsers();
            editText.setText("");
            /*while (k.moveToNext()) {
                //int nr = k.getInt(0);
                String email = k.getString(1);
                String password = k.getString(2);
